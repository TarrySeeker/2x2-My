...
export const PORTFOLIO_STUB: PortfolioStub[] = [
  {
    ...
    year: 2024,
    cover_url: "/port/print-visiting-cards-catalogs.webp",
    images: ["/port/print-visiting-cards-catalogs.webp"],
    is_featured: true,
    is_published: true,
    sort_order: 10,
  },
