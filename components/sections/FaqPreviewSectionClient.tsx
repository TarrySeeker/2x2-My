...
function FaqCard({
  ...
  return (
    <div className="relative">
      {/*
        Анимация появления (whileInView + slide-in + rotate) и ambient-
        floating убраны по правке клиента 2026-04-25 — «надо убрать
        анимированное появление». Открытие/закрытие аккордеона
        (AnimatePresence ниже), эмодзи-idle и hover/tap — сохранены.
      */}
      <motion.div
    ...
    <section className="section-padding relative overflow-hidden bg-brand-dark">
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-20 items-start">
          {/*
            Анимация появления секции (whileInView slide-in заголовка и
            scale-in badge) убрана по правке клиента 2026-04-25 —
            «убрать анимированное появление». Idle-pulsing «Нажмите на
            вопрос» оставлен (это hint-индикатор, не появление).
          */}
          <div className="lg:sticky lg:top-32">
            <div className="inline-flex items-center gap-2 bg-brand-orange/15 text-brand-orange px-5 py-2 rounded-full text-sm font-bold mb-6">
