...
// 2026-05-08: основание в 2014 → на 2026 год корректно "10+ лет"
// (раньше стояло "12+", что обещало старт в 2014 уже летом 2026,
// но пиково-маркетингово выглядело как "сейчас уже 12 лет" —
// несостыковка с JSON-LD foundingDate=2014).
const DEFAULT_STATS: AboutStat[] = [
  { icon: 'Calendar',  value: 10,  suffix: '+', label: 'лет на рынке' },
...
const DEFAULT_ABOUT: AboutSectionData = {
  ...
  paragraphs: [
    'Мы делаем рекламу для бизнеса в ХМАО и ЯНАО с 2014 года. Полиграфия, наружная реклама, вывески, световые буквы, оформление фасадов и транспорта — всё под ключ, от эскиза до монтажа.',
