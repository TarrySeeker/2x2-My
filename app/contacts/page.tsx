...
export const generateMetadata = makeGenerateMetadata({
  path: '/contacts',
  fallback: {
    // Title укорочён с 79 до 47 символов (вписывается в SERP-обрезку
    // Google/Yandex). К нему добавляется суффикс ` | 2х2` из layout
    // → итог 53 символа.
    title: 'Контакты — Ханты-Мансийск, ул. Парковая 92 Б',
    description:
      'Телефон +7 (932) 424-77-40, адрес: г. Ханты-Мансийск, ул. Парковая, 92 Б. Часы работы: Пн–Пт 09:00–19:00. Форма заявки, карта, мессенджеры.',
...
export default async function ContactsPage() {
  ...
  const mapTitle = infoCms?.content.map_iframe_title || 'Карта офиса 2х2'
